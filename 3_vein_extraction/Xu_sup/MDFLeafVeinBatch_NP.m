...
% DownSample = 2;
% for already downsampled data in repository
MicronPerPixel = 1.6807*2;
DownSample = 1;
...
for iF = 1:numel(FolderNames)
    try
        ...
        % run the analysis
        results = MDFLeafVeinAnalysis_NP(FolderNames{iF},MicronPerPixel,DownSample,threshold,ShowFigs,ExportFigs,FullLeaf,FullMetrics);
    catch ME
        ME
